...
public class GameManager : MonoBehaviourPun
{
    ...
    public void GameExit()
    {
        if (StateManager.Instance() != null)
        {
            ...
            StateManager.Instance().factorys = new SerializedDictionary<string, List<int[]>><string, List<int[]>>() { { "ProductionMachine", new List<int[]> { new int[] { 0, 5 } } }, { "WaterTank", new List<int[]> { new int[] { 0, 5 } } }, { "DynamiteMachine", new List<int[]>() } };
