...
public class GameManager : MonoBehaviourPun
{
    ...
    public void GameEnd()
    {
        ...
        PhotonNetwork.RaiseEvent((int)SendDataInfo.Info.GAME_MODE, data, raiseEventOptions, SendOptions.SendReliable);
        TimeManager.Instance().roundClearTimeList.Clear();
        Debug.Log("팀 다이너마이트:::::::::::::::::::::::::::::::::::::::::::"+StateManager.Instance().dynamiteMachines.Count.ToString());
        Debug.Log("팀 제작소:::::::::::::::::::::::::::::::::::::::::::"+StateManager.Instance().dynamiteMachines.Count.ToString());
        Debug.Log("팀 물탱크:::::::::::::::::::::::::::::::::::::::::::"+StateManager.Instance().dynamiteMachines.Count.ToString());
