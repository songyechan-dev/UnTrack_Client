...
public class GameManager : MonoBehaviourPun
{
    ...
    public void GameExit()
    {
        ...
        factorys = { { "ProductionMachine", new List<int[]> { new int[] { 0, 5 } } }, { "WaterTank", new List<int[]> { new int[] { 0, 5 } } }, { "DynamiteMachine", new List<int[]>() } }

                engineUpgradePrice = 3;
                storageUpgradePrice = 2;

                factoryPrice = new Dictionary<string, List<int>>() { { "ProductionMachine", new List<int> { 1 } }, { "WaterTank", new List<int> { 1 } }, { "DynamiteMachine", new List<int> { 1 } } }
        machineAddPrice = new Dictionary<string, int>() { { "ProductionMachine", 2 }, { "WaterTank", 2 }, { "DynamiteMachine", 2 } }

        currentTime = 0.0f
        fireTime = 20.0f

        BringFactoryValue() 함수 실행
