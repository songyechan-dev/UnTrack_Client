...
public class PhotonManager : MonoBehaviourPunCallbacks
{
    ...
    public override void OnPlayerLeftRoom(Player player)
    {
        ...
        // 방을 나간 플레이어의 게임 오브젝트를 찾아서 삭제
        GameObject playerObject = GetPlayerObjectByActorNumber(otherPlayer.ActorNumber);
    ...
    private GameObject GetPlayerObjectByActorNumber(int actorNumber)
    {
        // 방을 나간 플레이어의 게임 오브젝트를 찾아서 반환
