...
public class PhotonManager : MonoBehaviourPunCallbacks
{
    ...
    [Header("UI")]
    public InputField userIDIF;
    public InputField roomNameIF;

    public GameObject teamInfoListView;
    ...
    private void Start()
    {
        ...
        {
            userID = $"임의의 이름{Random.Range(0, 99999999)}{Random.Range(0, 99999999)}{Random.Range(0, 99999999)}";
        }
        else
        {
            userID = userIDIF.text;
        }
        //데이터 저장기능 필요
