...
public class TeamManager : MonoBehaviourPunCallbacks
{
    ...
    public override void OnPlayerLeftRoom(Player otherPlayer)
    {
        if (PhotonNetwork.IsMasterClient && exitedPlayerActNo != otherPlayer.ActorNumber)
        {
            ...
            if (playerCustomProperties.ContainsKey("IsReady") && (bool)playerCustomProperties["IsReady"] && playerCustomProperties.ContainsKey("Scene") && (int)playerCustomProperties["Scene"] == SceneManager.GetActiveScene().buildIndex)
            {
