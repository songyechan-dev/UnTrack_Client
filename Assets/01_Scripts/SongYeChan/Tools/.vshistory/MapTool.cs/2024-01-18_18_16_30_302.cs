...
public class MapTool : EditorWindow
{
    ...
    private float endTrackRotation;
    ...
    private void OnGUI()
    {
        ...
        if (selectedMode.Equals(MapMode.CreateMap))
        {
            ...
            startTrackYRotation = (Vector3)EditorGUILayout.Vector3Field("Start Track Rotation:", startTrackYRotation);
    ...
    private void MapDataCreate()
    {
        ...
        string content = "";
        string rotationInfo = $"startTrackRotation,{startTrackYRotation}\nendTrackRotation,{endTrackRotation}";
        string mapInfo = "0";
