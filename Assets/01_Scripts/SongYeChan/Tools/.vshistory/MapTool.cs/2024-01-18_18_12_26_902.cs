...
public class MapTool : EditorWindow
{
    ...
    private Vector3 startTrackRotation;
    private Vector3 endTrackRotation;
    ...
    private void OnGUI()
    {
        ...
        if (selectedMode.Equals(MapMode.CreateMap))
        {
            ...
            startTrackRotation = (Vector3)EditorGUILayout.Vector3Field("Start Track Rotation:", startTrackRotation);
            endTrackRotation = (Vector3)EditorGUILayout.Vector3Field("End Track Rotation:", endTrackRotation);
    ...
    private void MapDataCreate()
    {
        ...
        string startTrackRotationInfoFilePath = Path.Combine(Application.streamingAssetsPath, csvFileName);
        string content = "";
        string rotationInfo = $"startTrackRotation,{startTrackRotation}\nendTrackRotation,{endTrackRotation}";
        string mapInfo = "0";
