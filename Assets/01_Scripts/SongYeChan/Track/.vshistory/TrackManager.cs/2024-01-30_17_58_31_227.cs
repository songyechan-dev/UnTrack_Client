        ...
        if (Physics.Raycast(_ray, out hit))
        {
            ...
            if (Physics.Raycast(new Ray(track.transform.position, Vector3.forward), out forwardHit, maxDistance))
            {
                ...
                if (forwardHit.transform.CompareTag(trackTagName))
                {
                    ...
                    if (forwardTrackInfo.transform.localEulerAngles.y == 0)
                    {
                        Debug.Log("여기 호출");
                    ...
                    else if (Mathf.Abs(forwardTrackInfo.transform.localEulerAngles.y) == 90f || forwardTrackInfo.transform.localEulerAngles.y == 270f)
                    {
                        Debug.Log("여기 호출");
            ...
            if (Physics.Raycast(new Ray(track.transform.position, Vector3.back), out backHit, maxDistance))
            {
                ...
                if (backHit.transform.CompareTag(trackTagName))
                {
                    ...
                    Debug.Log("각도 :::: "+backTrackInfo.transform.forward.y);
                    if (backTrackInfo.transform.localEulerAngles.y == 90f)
                    {s
                    ...
                    else if (backTrackInfo.transform.localEulerAngles.y == -90f)
                    {
