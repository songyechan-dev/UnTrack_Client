...
public class TrackManager : MonoBehaviour
{
    ...
    public TrackInfo leftTrackPrevDirection;
    public TrackInfo leftTrackPrevAngle;

    public TrackInfo rightTrackPrevDirection;
    public TrackInfo rightTrackPrevAngle;
        ...
        if (Physics.Raycast(ray, out hit))
        {
            if (hit.transform.CompareTag(planeTagName))
            {
                ...
                if (!trackConnectFailed)
                {
                    ...
                    if (leftHit.transform != null && leftHit.transform.GetComponent<TrackInfo>().isActiveAndEnabled)
                    {
                        leftHit.
                    }
                }
