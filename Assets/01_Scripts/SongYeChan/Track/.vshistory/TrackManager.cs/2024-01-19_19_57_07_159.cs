        ...
        if (Physics.Raycast(ray, out hit))
        {
            if (hit.transform.CompareTag(planeTagName))
            {
                ...
                if ((hitList[0].transform != null && hitList[0].transform.gameObject != finalTrack) && (hitList[1].transform != null && hitList[1].transform.gameObject != finalTrack) 
                    ...
                    || (hitList[2].transform != null && hitList[2].transform.gameObject != finalTrack) && (backHit.transform != null && backHit.transform.gameObject != finalTrack)
                    || (hitList[2].transform != null && hitList[2].transform.gameObject != finalTrack) && (backHit.transform == null)
                    || (backHit.transform != null && backHit.transform.gameObject != finalTrack) && (hitList[2].transform == null)
                    )
                {
                ...
                if ((hitList[2].transform != null && !hitList[2].transform.GetComponent<TrackInfo>().isElectricityFlowing && backHit.transform == null)
                    || (hitList[2].transform != null && !hitList[2].transform.GetComponent<TrackInfo>().isElectricityFlowing && backHit.transform != null
                ...
                if ((backHit.transform != null && !backHit.transform.GetComponent<TrackInfo>().isElectricityFlowing && hitList[2].transform == null)
                    || (backHit.transform != null && !backHit.transform.GetComponent<TrackInfo>().isElectricityFlowing && hitList[2].transform != null
                ...
                if (hitList[2].transform == null && backHit.transform == null && hitList[0].transform == null && hitList[1].transform == null)
                {
                    trackConnectFailed = true;
                    track.GetComponent<MeshRenderer>().material = droppedTrackPrefabMaterial;
                    track.tag = droppedTrackTagName;
