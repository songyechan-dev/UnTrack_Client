    ...
    public void TrackCreate(Ray _ray)
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            if (hit.transform.CompareTag(planeTagName))
            {
                ...
                if ((hitList[0].transform != null && hitList[0].transform.gameObject != finalTrack) && (rightHit.transform != null && rightHit.transform.gameObject != finalTrack) 
                    || (hitList[0].transform != null && hitList[0].transform.gameObject != finalTrack) && (rightHit.transform == null)
                    || (rightHit.transform != null && rightHit.transform.gameObject != finalTrack) && (hitList[0].transform == null)
                ...
                if ((hitList[0].transform != null && !hitList[0].transform.GetComponent<TrackInfo>().isElectricityFlowing && rightHit.transform == null)
                    || (hitList[0].transform != null && !hitList[0].transform.GetComponent<TrackInfo>().isElectricityFlowing && rightHit.transform != null 
                ...
                if ((rightHit.transform != null && !rightHit.transform.GetComponent<TrackInfo>().isElectricityFlowing && hitList[0].transform == null)
                    ||(rightHit.transform != null && !rightHit.transform.GetComponent<TrackInfo>().isElectricityFlowing && hitList[0].transform != null 
                ...
                if (forwardHit.transform == null && backHit.transform == null && hitList[0].transform == null && rightHit.transform == null)
                {
                    trackConnectFailed = true;
                    track.GetComponent<MeshRenderer>().material = droppedTrackPrefabMaterial;
                    track.tag = droppedTrackTagName;
                ...
                {
                    if (hitList[0].transform != null && leftHit.transform.GetComponent<TrackInfo>().isElectricityFlowing)
                    {
