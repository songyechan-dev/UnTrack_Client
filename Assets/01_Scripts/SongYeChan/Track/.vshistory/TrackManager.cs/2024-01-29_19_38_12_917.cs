...
public class TrackManager : MonoBehaviourPun
{
    ...
    public void TrackCreate(Ray _ray)
    {
        ...
        if (Physics.Raycast(_ray, out hit))
        {
            ...
            float roundedX = Mathf.Round(_ray.origin.x / trackPrefab.transform.localScale.z) * trackPrefab.transform.localScale.z;
            float roundedZ = Mathf.Round(_ray.origin.z / trackPrefab.transform.localScale.z) * trackPrefab.transform.localScale.z;
