...
public class TrackManager : MonoBehaviour
{
    ...
    public GameObject finalTrackList;
    public void TrackCreate(Ray _ray)
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            if (hit.transform.CompareTag(planeTagName))
            {
                ...
                if ((leftHit.transform != null && !leftHit.transform.GetComponent<TrackInfo>().isElectricityFlowing && rightHit.transform == null && leftHit.transform != finalTrackList)
