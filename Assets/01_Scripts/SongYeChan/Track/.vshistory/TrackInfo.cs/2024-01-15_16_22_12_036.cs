...
public class TrackInfo : MonoBehaviour
{
    ...
    private void Awake()
    {
        InitArroundTrackInfo();
    }

    public void InitArroundTrackInfo()
    {
        arroundTrackInfo.Add(ArroundTrackDirection.UP, false);
        arroundTrackInfo.Add(ArroundTrackDirection.DOWN, false);
        arroundTrackInfo.Add(ArroundTrackDirection.LEFT, false);
        arroundTrackInfo.Add(ArroundTrackDirection.DOWN, false);
    }

    public void ChangArroundTrackInfo(ArroundTrackDirection _arroundTrackDirection,bool _isElectricityFlowing)
    {
    ...
    public void SetAroundTrack(Transform otherTrack, ArroundTrackDirection _arroundTrackDirection)
    {
