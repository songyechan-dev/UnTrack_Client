...
public class MapCreator : MonoBehaviour
{
    ...
    {
        GameObject go = Instantiate(Resources.Load<GameObject>(mapEnvironmentPrefab.name), new Vector3(26.1000004f, -1.04999995f, 3.23810005f), Quaternion.Euler(new Vector3(0,90f,0)));
