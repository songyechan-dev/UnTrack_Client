...
public class MapCreator : MonoBehaviour
{
    ...
    {
        Debug.Log("마스터 호출");
        _obj = PhotonNetwork.Instantiate(name, new Vector3(x * objScale * 10, planeObject.transform.position.y - (planeObject.transform.localScale.y /2) + objScale * 5, z * objScale * 10), Quaternion.identity);
