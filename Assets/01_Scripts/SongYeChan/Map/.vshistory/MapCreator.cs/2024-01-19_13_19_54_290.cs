...
public class MapCreator : MonoBehaviour
{
    ...
    {
        string mapDataFilePath = Path.Combine(Application.streamingAssetsPath, MapInfo.mapDataCsvName);
        string startTrackRotationInfoFilePath = Path.Combine(Application.streamingAssetsPath, MapInfo.trackYRotationInfoFileName);
        string content = "";
        string rotationInfo = $"{startTrackYRotationKeyName},{MapInfo.startTrackYRotation}\n{endTrackYRotationKeyName},{MapInfo.endTrackYRotation}";
        string mapInfo = "0";
    ...
    private IEnumerator CSVLoad()
    {
        ...
        string mapCSV = Path.Combine(Application.streamingAssetsPath, MapInfo.mapDataCsvName + round.ToString());
        TextAsset rotationInfoCSV = Resources.Load<TextAsset>(MapInfo.trackYRotationInfoFileName + round.ToString());
        mapInfo.Clear();
        ...
        if (rotationInfoCSV != null)
        {
            Debug.Log("NotNull");
            rotationInfoDict.Clear();
            string[] rotationLines = rotationInfoCSV.text.Split('\n');
