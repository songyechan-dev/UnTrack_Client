...
public class MapCreator : MonoBehaviour
{
    ...
    void CreateTrack_Master(float x, float y, float z, string name,int i, int j)
    {
        ...
        trackObject = PhotonNetwork.Instantiate(name, new Vector3(x * trackPrefab.transform.localScale.x, trackPrefab.transform.localScale.y / 2, z * trackPrefab.transform.localScale.z),Quaternion.Euler(new Vector3(0,MapInfo.startTrackYRotation,0)));
