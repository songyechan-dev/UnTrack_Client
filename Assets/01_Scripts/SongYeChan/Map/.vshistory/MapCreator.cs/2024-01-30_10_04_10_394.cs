...
public class MapCreator : MonoBehaviour
{
    ...
    void CreateTrack_Master(float x, float y, float z, string name,int i, int j)
    {
        ...
        {
            trackObject.transform.localEulerAngles = new Vector3(trackPrefab.transform.localRotation.x, MapInfo.startTrackYRotation, trackPrefab.transform.localRotation.z);
            trackManager.finalTrack = trackObject;
            isTrack = true;
        }
        else
        {
            trackObject.transform.localEulerAngles = new Vector3(trackPrefab.transform.localRotation.x, MapInfo.endTrackYRotation, trackPrefab.transform.localRotation.z);
