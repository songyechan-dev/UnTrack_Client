...
public class MapCreator : MonoBehaviour
{
    ...
    void CreatePlane_Master(float x, float y, float z)
    {
        ...
        planeObject.transform.position = new Vector3(x, y, z);
        planeObject.transform.localScale = new Vector3(objScale *10, objScale *10, objScale *10);
    ...
    {
        Debug.Log("마스터 호출");
        GameObject _obj = PhotonNetwork.Instantiate(name, new Vector3(x, planeObject.transform.position.y + 1f, z), Quaternion.identity);
