...
public class MapCreator : MonoBehaviour
{
    ...
    void CreateTrack_Master(float x, float y, float z, string name,int i, int j)
    {
        ...
        trackObject = PhotonNetwork.Instantiate(name, new Vector3(x * objScale * 10, planeObject.transform.localPosition.y +(trackPrefab.transform.localScale.y * 0.0005f), z * objScale * 10),Quaternion.Euler(new Vector3(0,MapInfo.startTrackYRotation,0)));
