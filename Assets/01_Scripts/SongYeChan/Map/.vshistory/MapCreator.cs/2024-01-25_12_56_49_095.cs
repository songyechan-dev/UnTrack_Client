...
public class MapCreator : MonoBehaviour
{
    ...
    void CreateObject(float x, float y, float z,string name,GameObject _obj,int k)
    {
        Debug.Log("마스터 호출");
        _obj = PhotonNetwork.Instantiate(name, new Vector3(x * objScale * 10, k == 0 ? planeObject.transform.position.y + objScale * 5 : (prevCreatedYPos + objScale * 10), z * objScale * 10), Quaternion.identity);
