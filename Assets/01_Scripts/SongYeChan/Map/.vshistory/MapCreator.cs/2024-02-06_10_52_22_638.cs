...
public class MapCreator : MonoBehaviour
{
    ...
    {
        GameObject go = Instantiate(Resources.Load<GameObject>(mapEnvironmentPrefab.name),new Vector3(0,-0.15f,0),Quaternion.Euler(new Vector3(0,90f,0)));
    ...
    {
        GameObject go = Instantiate(Resources.Load<GameObject>(mapEnvironmentPrefab.name), new Vector3(0, -0.15f, 0), Quaternion.identity);
    }
