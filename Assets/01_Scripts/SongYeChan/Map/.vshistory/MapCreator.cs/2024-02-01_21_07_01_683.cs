    ...
    public void Create()
    {
        ...
        for (int i = 0; i < mapY; i++)
        {
            for (int j = 0; j < mapX; j++)
            {
                ...
                {
                    if (i > MapInfo.defaultStartTrackZ - 2 && (j >= MapInfo.defaultStartTrackX && j < MapInfo.defaultEndTrackX))
                    {
                        return;
                    }
                ...
                {
                    if ((j >= MapInfo.defaultStartTrackX && j < MapInfo.defaultEndTrackX) && (i < MapInfo.defaultStartTrackZ - 2 || i> MapInfo.defaultStartTrackZ +1) )
                    {
                        return;
                    }
