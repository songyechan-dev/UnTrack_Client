...
public class MapCreator : MonoBehaviour
{
    ...
    Dictionary<Transform,Vector3> defaultPlaneList = new Dictionary<Transform, Vector3>();
    ...
    void CreatePlane_Master(float x, float y, float z)
    {
        ...
        defaultPlaneList.Add(planeObject.transform, planeObject.transform.position);
