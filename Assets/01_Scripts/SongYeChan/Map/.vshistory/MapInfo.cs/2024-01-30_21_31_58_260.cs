...
public static class MapInfo
{
    ...
    public static float startPositionX = 0f;
    public static float startPositionY = 0f;
    public static float startPositionZ = 0f;

    public static float endPositionX = 0f;
    public static float endPositionY = 0f;
    public static float endPositionZ = 0f;
