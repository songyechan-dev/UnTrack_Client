...
public static class MapInfo
{
    ...
    public static int defaultStartTrackX = 48;

    public static int defaultEndTrackZ = 5;
    public static int defaultEndTrackX = 60;

    public static int finishStartTrackZ = 5;
    public static int finishStartTrackX = 90;

    public static int finishEndTrackZ = 5;
    public static int finishEndTrackX = 100;
