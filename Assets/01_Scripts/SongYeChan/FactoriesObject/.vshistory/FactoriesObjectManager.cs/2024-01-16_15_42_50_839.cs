    ...
    void SensorDetect()
    {
        if (sensorTransform != null)
        {
            ...
            if (Physics.Raycast(ray, out hit, Mathf.Infinity))
            {
                ...
                {
                    if (hit.transform.GetComponent<TrackInfo>().myDirection == TrackInfo.ShapeDirection.LEFT)
                    {
                        moveDirection = MoveDirection.LEFT;
                    }
                    else if (hit.transform.GetComponent<TrackInfo>().myDirection == TrackInfo.ShapeDirection.RIGHT)
                    {
