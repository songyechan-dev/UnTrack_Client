    ...
    void SensorDetect()
    {
        if (sensorTransform != null)
        {
            ...
            if (Physics.Raycast(ray, out hit, Mathf.Infinity))
            {
                ...
                {
                    if (hit.transform.GetComponent<TrackInfo>().shapeDirection == TrackInfo.ShapeDirection.LEFT)
                    {
                        moveDirection = MoveDirection.LEFT;
                    }
                    else if (hit.transform.GetComponent<TrackInfo>().shapeDirection == TrackInfo.ShapeDirection.RIGHT)
                    {
