...
public class FactoriesObjectManager : MonoBehaviour
{
    ...
    void CheckDirection()
    {
        ...
        if (moveDirection == MoveDirection.FORWARD)
        {
            ...
            {
                float lessAngle = changedRotateAngle.Equals(MoveDirection.LEFT) ? -90f : 90f;
                float greaterAngle = changedRotateAngle.Equals(MoveDirection.LEFT) ? 270f : -270f;
        ...
        {
            float lessAngle = moveDirection.Equals(MoveDirection.LEFT) ? -90f : 90f;
            float greaterAngle = moveDirection.Equals(MoveDirection.LEFT) ? 270f : -270f;
