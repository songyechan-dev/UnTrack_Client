...
public class FactoriesObjectManager : MonoBehaviourPun
{
    ...
    void Update()
    {
        ...
        if (!GameManager.Instance().gameState.Equals(GameManager.GameState.GameStart) && UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex ==3)
        {
            GameManager.Instantiate.gameState = GameManager.GameState.GameStart;
        }
    }
    /// <summary>
