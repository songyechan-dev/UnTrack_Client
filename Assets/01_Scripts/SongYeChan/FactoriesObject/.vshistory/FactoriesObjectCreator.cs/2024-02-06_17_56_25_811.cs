...
public class FactoriesObjectCreator : MonoBehaviour
{
    ...
    public void FirstCreate_Master()
    {
        ...
        factoriesFirstObject.transform.GetChild(0).GetComponent<MeshRenderer>().enabled = false;
        factoriesFirstObject.transform.GetChild(1).GetComponent<MeshRenderer>().enabled = false;
