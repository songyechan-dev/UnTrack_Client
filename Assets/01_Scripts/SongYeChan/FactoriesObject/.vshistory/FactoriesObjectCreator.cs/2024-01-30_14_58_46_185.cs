...
public class FactoriesObjectCreator : MonoBehaviour
{
    ...
    {
        GameObject factoriesObject = PhotonNetwork.Instantiate("FactoriesObject", new Vector3(MapInfo.defaultStartTrackX * MapInfo.objScale * 10, 0.1f, MapInfo.defaultStartTrackZ * MapInfo.objScale * 10),Quaternion.Euler(new Vector3(0, MapInfo.startTrackYRotation, 0)));
    ...
    {
        GameObject factoriesObject = Instantiate(factoriesObjectPrefab, new Vector3(MapInfo.defaultStartTrackX * MapInfo.objScale * 10, 0.1f, MapInfo.defaultStartTrackZ * MapInfo.objScale * 10), Quaternion.Euler(new Vector3(0, MapInfo.startTrackYRotation, 0)));
        factoriesObject.AddComponent<FactoriesObjectManager>();
        factoriesObject.GetComponent<FactoriesObjectManager>().tagToBeDetected = "Track";
        factoriesObject.GetComponent<FactoriesObjectManager>().Init();
