...
public class FactoriesObjectCreator : MonoBehaviour
{
    ...
    public void FirstCreate_Master()
    {
        ...
        if (factoriesObject.transform.GetComponent<Rigidbody>() != null)
        {
            Destroy(factoriesObject.transform.GetComponent<Rigidbody>());
            factoriesObject.AddComponent<Rigidbody>();
            Destroy(factoriesObject.transform.GetComponent<Rigidbody>());
