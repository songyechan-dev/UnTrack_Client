...
public class UIManager : MonoBehaviour
{
    ...
    public void PlayAbleButton_OnStay(PlayableButtonInfo.Info _info)
    {
        switch (_info)
        {
            case PlayableButtonInfo.Info.GAME_START_01:
                ...
                break;
            case PlayableButtonInfo.Info.GAME_EXIT01:
                break;
            case PlayableButtonInfo.Info.RANKING01:
                break;
            case PlayableButtonInfo.Info.SETTING01:
                break;
            default:
                break;
        }
    ...
    public void Init()
    {
        ...
        if (SceneManager.GetActiveScene().name.Equals("01_Intro"))
        {
            ...
            playableButton_Ranking01.GetComponent<PlayableButtonInfo>().myInfo = PlayableButtonInfo.Info.RANKING01;
            playableButton_Setting01.GetComponent<PlayableButtonInfo>().myInfo = PlayableButtonInfo.Info.SETTING01;
            playableButton_GameExit01.GetComponent<PlayableButtonInfo>().myInfo = PlayableButtonInfo.Info.GAME_EXIT01;
