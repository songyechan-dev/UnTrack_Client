...
public class UIManager : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        if (SceneManager.GetActiveScene().buildIndex == 2)
        {
            ...
            roomListPanel02.transform.Find("RoomListBackGround").transform.Find("Xbutton").GetComponent<Button>().onClick.AddListener(()=> OnClickCloseBtn(""))
    ...
    void OnClickCloseBtn(string type)
    {
        if (type.Equals("RoomList01_Close"))
        {
