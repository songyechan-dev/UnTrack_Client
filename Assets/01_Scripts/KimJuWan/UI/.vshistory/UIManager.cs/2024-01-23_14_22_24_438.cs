...
public class UIManager : MonoBehaviour
{
    ...
    {
        string user_id = loginPanel.transform.Find("InputID").GetComponent<Text>().text;
        string user_password = loginPanel.transform.Find("InputPW").GetComponent<Text>().text;
        WebServerManager.LoginCoroutine(user_id, user_password);
    }
