...
public class UIManager : MonoBehaviour
{
    ...
    public delegate void SpaceKeyPressAction();
    public static event SpaceKeyPressAction OnSpaceKeyPress;
    ...
    void CheckSpaceKeyUp()
    {
        ...
        {
            GameManager.Instance().SleepCoroutine(0.5f, CheckSpaceKeyUp);
        }
    }
