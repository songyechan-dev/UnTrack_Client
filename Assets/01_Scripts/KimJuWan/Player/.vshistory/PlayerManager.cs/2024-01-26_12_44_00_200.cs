...
public class PlayerManager : MonoBehaviourPun
{
    ...
    public void PickedItemSetPosition(Transform _originTr, Transform _targetTr)
    {
        photonView.RPC("PickedItemSetPosition_Sync", RpcTarget.Others, _originTr, _targetTr);
    }

    [PunRPC]
    public void PickedItemSetPosition_Sync(Transform _originTr, Transform _targetTr)
    {
        _originTr = _targetTr;
    }
