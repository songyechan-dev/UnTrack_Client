...
public class ObstacleManager : MonoBehaviour
{
    ...
    public void GenerateIngredient(PlayerController _player)
    {
        ...
        GameObject _object = PhotonNetwork.Instantiate(generateItem, new Vector3(_player.transform.position.x, _player.transform.position.y, _player.transform.position.z)+Vector3.back, transform.rotation);
